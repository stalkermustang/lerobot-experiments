"""Training entry-point with SO101 defaults and sampler extensions."""
...
def train(cfg: TrainPipelineConfig):
    ...
    drop_first = getattr(cfg.policy, "drop_n_first_frames", 0)
    drop_last = getattr(cfg.policy, "drop_n_last_frames", 0)
